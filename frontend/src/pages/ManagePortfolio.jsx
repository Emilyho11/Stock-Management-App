...
import { faArrowLeft, faX, faChartSimple, faPen, faCheck, faTimes } from "@fortawesome/free-solid-svg-icons";
...
const ManagePortfolio = () => {
    const [showStocks, setShowStocks] = useState(null);
    ...
    const [stockCov, setStockCov] = useState(0);
    ...
    const handleSaveName = async () => {
        try {
            await AxiosClient.patch(`portfolio/rename/${portfolio.id}/${newName}`);
    ...
    return (
        <div className="md:w-2/3 ml-auto mr-auto flex flex-col gap-2">
            ...
            <Card className="flex flex-col !bg-transparent !items-start !p-0 lg:flex-row mb-14">
                <h1 className="text-left text-2xl mb-2 flex gap-6 items-center">
                    {isEditing ? (
                        <>
                            <input
                                type="text"
